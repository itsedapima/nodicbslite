(function(){
    ...
    accountSelect.addEventListener('change', function(){
        loanTypeSelect.disabled = (this.value !== 'loan');
    });
    ...
    // New render function for table display
    ...
    previewBtn.addEventListener('click', function(){
        ...
        if(!qs) {
            stmDisplay.innerHTML = `<div class="text-center text-danger p-5"><i class="fas fa-exclamation-circle fa-2x mb-2"></i><p>Please select a customer.</p></div>`;
            return;
        }
